"""9.9. Uaktualnienie akumulatora. Pracę rozpocznij od ostatniej wersji programu electric_car.py utworzonej w tym podrozdziale. Do klasy Battery dodaj
nową metodę o nazwie upgrade_battery(). Ta metoda powinna sprawdzić
pojemność akumulatora i ustawić ją na 85, jeśli aktualnie jest inna. Utwórz
egzemplarz samochodu o napędzie elektrycznym wraz z akumulatorem
o domyślnej pojemności, wywołaj metodę get_range(), a następnie metodę
upgrade_battery() i ponownie get_range(). Powinieneś zauważyć zwiększenie zasięgu samochodu."""
